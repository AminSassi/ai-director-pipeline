...
## Broken Rule #1 — Characters pose instead of being mid-action
...
## Broken Rule #2 — Only objects shown when VO mentions a person
...
## Broken Rule #3 — Camera angles are boring
...
## Broken Rule #4 — Short VO lines get too many shots
- 2–5 words → 2 shots ONLY
- 6–12 words → 3 shots
- 13–20 words → 4 shots
- 20–30+ words → SPLIT into 2 scenes, 4 shots each

## Broken Rule #5 — Image referenced when file doesn't exist
- Never write imageN if that file is not physically uploaded
- Board doesn't exist → describe fully inline

## Broken Rule #6 — Kling negative prompts in separate field
