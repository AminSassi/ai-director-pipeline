# Phase 1 — Pre-Production: AUR0RA — THE RUSSIAN HACKERS WHO TURNED ELON MUSK'S AI AGAINST THE WORLD
# Status: READY
# Total Chunks: 40 | Runtime: 10:00 (600s)
...
- Teckentrup German industrial manufacturing plant workers, automated door stamping machinery
- Helideck Certification Agency inspectors, North Sea offshore helicopter deck landing crews in survival suits
- Argentine pharmaceutical distributor warehouse workers, refrigerated insulin and antibiotic supply crates
- Louisiana title insurance deed vault clerks, Northern Italian precision lathe machine operators
- Silicon Valley software engineers collaborating in open-plan glass offices
- Reuters London newsroom investigative journalists on phone terminals
- Cisco Talos threat researchers in security operations center
...
| Act / Phase | Chunks | Setting & Visual Core | Key Visual Metaphors & Anchors |
| :--- | :--- | :--- | :--- |
| **Hook** | 1–5 | Real-world intrusion stakes, dark cityscapes, Starbase gantry | Cold corporate towers, lone hacker room, satellite dish, analog tape reel |
| **Act 1: The Tool** | 6–10 | Silicon Valley engineering floor, Starbase high bay, Starship assembly | Plain English programming, Elon Musk at Starbase, autonomous AI agency |
| **Act 2: The Syndicate** | 11–15 | Russian safehouse, real-world victim facilities across 4 continents | Belgian chemical plant, German door factory, North Sea helideck, Argentine pharma, Louisiana deed vault |
| **CTA Midpoint** | 16 | Moody architectural reflection, Washington / tech capital dusk | Clean graphic transition, dark glass facade |
| **Act 3: The Attack Chain** | 17–25 | Gambit Tel Aviv lab, corporate victim offices, phishing entry, tea-lit room | Eyal Sela log audit, emoji chat logs, 6-stage intrusion, machine psychology whiteboard |
| **Act 4: The Blunder** | 26–30 | Chilly colocation datacenter, Tel Aviv discovery, Singapore operations, Reuters London | Unlatched server rack door, 28 chat sessions, CloudSec war room, Reuters newsroom |
| **Act 5: The Aftermath** | 31–35 | SpaceX exterior, Cisco Talos center, microprocessor macro, Moscow dawn balcony | Curtis Simpson interview, Zig cross-compilation, CIS restriction, sunrise over river |
| **Outro & Conclusion** | 36–40 | Starbase rocket silhouette, foreign defense ministry, optical lens macro, closing slate | Sovereign AI warfare question, lens fade, Insolvent twilight outro |

---

## 4. ENERGY MAP

| Chunk Range | Narrative Beat | Visual Energy | Camera Style |
| :--- | :--- | :--- | :--- |
| **Chunks 1–4** | The Hook & Elon Musk AI weaponization | **HIGH (8/10)** | Dynamic pushes, low-angle tilts, crisp drone reveals |
| **Chunk 5** | CTA #1 & Intro Transition | **CONTROLLED (5/10)** | Smooth slow tracking, atmospheric stillness |
| **Chunks 6–9** | Cursor capabilities &  SpaceX acquisition | **RISING (7/10)** | Fluid crane movements, macro typing, grand rocket scale |
| **Chunks 10–14** | Aur0ra global victims across 4 continents | **HIGH-IMPACT (8.5/10)** | Fast industrial tracking: chemical vats, stormy sea helideck, cold pharma warehouse |
| **Chunk 15–16** | Summary & CTA #2 | **CONTROLLED (5/10)** | Moody architectural pan, twilight reflection |
| **Chunks 17–24** | The surreal attack chain & emoji logs | **TENSE & DELIBERATE (7.5/10)** | Tight handheld, macro document rack-focus, analytical whiteboard pans |
| **Chunks 25–27** | Catastrophic blunder: unpassworded server | **SHOCK / REVELATION (9/10)** | Dramatic slow push into ajar server door, intense forensic table reveals |
| **Chunks 28–32** | Global fallout, Reuters story, Cisco Talos | **PROPULSIVE (8/10)** | Newsroom tracking, dynamic curved screen pans, wide corporate glass |
| **Chunks 33–35** | Zig language & CIS sanctuary rules | **COLD & CALCULATING (7/10)** | Slow Dutch tilt, CPU macro, cold dawn balcony tracking |
| **Chunks 36–38** | Sovereign AI threat & the convincing lie | **PEAK CHILL (9/10)** | Epic rocket silhouette vs shadowed alley, slow macro pull-out into darkness |
| **Chunks 39–40** | Final CTA & Channel Signoff | **ATMOSPHERIC (4/10)** | Elegant boardroom drift, lingering twilight fade |\n