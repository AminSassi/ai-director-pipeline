...
- **ASSET CONSISTENCY:** Always cross-reference your scene descriptions with the locked asset reference sheets. Do NOT introduce architectural features (like windows, doors, or layouts) that contradict the established locked asset.
